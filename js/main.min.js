...
var basketChildLength = basketList.children.length;
var modalBtn = document.querySelector('#modalButton');
var modalBtnFchild = modalBtn.firstElementChild;
modalBtnFchild.firstElementChild.innerHTML = basketChildLength;
var amount = document.querySelectorAll('.amount');

var _loop = function _loop(i) {
  var minus = amount[i].querySelector('.minus');
  var plus = amount[i].querySelector('.plus');
  var out = amount[i].querySelector('.out');
  var count = 1;
  out.innerHTML = count;
...
var btnMenu = document.querySelector('.button');

btnMenu.onclick = function () {
  btnMenu.classList.toggle('button-open');
  var navResponse = document.getElementById("navbarresponsive");
...
for (var i = 0; i < gblock.length; i++) {
  var heartIcon = gblock[i].querySelector('#heart');

  heartIcon.onmouseover = function () {
    if (_this.classList.contains('bi-heart')) {
      _this.classList.remove('bi-heart');

      _this.classList.add('bi-heart-fill');
    }
  };

  heartIcon.onmouseleave = function () {
    if (_this.classList.contains('bi-heart-fill')) {
      _this.classList.remove('bi-heart-fill');

      _this.classList.add('bi-heart');
    }
  };
...
document.querySelector('#sortRating').addEventListener('click', function () {
  sortListDesc("data-rating");
});
document.querySelector('#sortDiscount').addEventListener('click', function () {
...
var mobileDropdown = document.getElementById('dropdownMobile');
var mobileDropMenu = document.getElementById('dropdownMenuMobile');

mobileDropdown.onmouseover = function (event) {
  var target = event.target;
...
mobileDropMenu.onmouseleave = function (event) {
  var target = event.target;
